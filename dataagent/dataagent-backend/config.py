...
class Settings(BaseSettings):
    ...
    # Large NL2SQL tool results / partial messages can
    ...
    # are parked durably in PostgreSQL and no longer auto-deny by this timeout.
    ...
    # ---- PostgreSQL（DataAgent 内部持久化）----
    dataagent_database_url: str = (
        "postgresql://ontofoundry:ontofoundry@localhost:5432/ontofoundry"
    )
    ...
    # reuse it instead of paying full container/runtime cold-start each turn.
