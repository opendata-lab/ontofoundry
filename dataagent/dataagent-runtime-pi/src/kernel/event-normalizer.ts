 ...
 * Every Pi turn renders through the platform AgentEvent components.
 */
  ...
  public normalize(piEvent: PiAgentEvent): NeutralAgentEvent[] {
    ...
    switch (piEvent.type) {
      ...
      case "turn_end": {
        ...
        // was simply never recorded for this Pi turn.
        //
 ...
 * the sibling `output_meta`, keeping `output` in the platform-compatible shape.
 */
