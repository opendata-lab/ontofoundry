...
from dataagent_backend.core.skill_admin_service import _skill_description_from_front_matter
...
def test_the_description_comes_from_front_matter(tmp_path, monkeypatch):
    monkeypatch.setattr(
        "dataagent_backend.core.skill_admin_service.resolve_skill_discovery_root_dir", lambda: tmp_path
    )
    _write_skill(
        tmp_path,
        "demo-skill",
