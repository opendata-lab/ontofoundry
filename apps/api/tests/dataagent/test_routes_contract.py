...
import dataagent_backend.api.routes as routes
import dataagent_backend.main as main
from dataagent_backend.core.agent_profile_service import normalize_permission_mode
...
def test_create_topic_enforces_agent_visibility_for_anonymous(monkeypatch):
    ...
    monkeypatch.setattr("dataagent_backend.core.agent_visibility.is_auth_enabled", lambda: True)
