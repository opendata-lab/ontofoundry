"""Unit tests for the platform AgentEvent writer."""
...
from dataagent_backend.core.agent_event_writer import AgentEventWriter  # noqa: E402
...
def test_writes_neutral_records_as_agent_event():
    store = _FakeStore()
    writer = AgentEventWriter(store, "task-1", "topic-1")
...
def test_store_failure_is_swallowed_not_propagated():
    ...
    writer = AgentEventWriter(_BrokenStore(), "task-1", "topic-1")
