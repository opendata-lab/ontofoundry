...
"""
Skill discovery helpers for the Pi runtime.

This module only owns filesystem discovery of the skills root used by Pi.
Skill content is loaded by the runtime itself.
"""
