...
from dataagent_backend.core.skill_discovery import SkillDiscoveryError, resolve_skill_discovery_root_dir
...
def _replace_path_with_copy(dest: Path, source: Path) -> None:
    ...
    Copies instead of symlinking because some runtime skill
